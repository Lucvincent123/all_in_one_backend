...
export const drop_members_table = `
DROP TABLE circleMembers;
`;

export const insert_members_data = `
INSERT INTO circleMembers (userId, circleId) VALUES ($1, $2);
`;

export const select_all_members = `
SELECT * FROM circleMembers;
`;

export const select_all_circles = `
...
export const select_all_members_of_circle = `
SELECT userId, username, email, balance FROM circleMembers AS c, users AS u
WHERE c.userId = u.id
AND c.circleId = $1;
`;

export const select_all_members_not_in_circle = `
...
export const update_member_balance = `
